    ...
    return (
        <>
            ...
            <Container maxWidth={false}>    
                {props.salary !== null ? <SalaryList/> : <div style={{margin:'180px 450px auto'}}><CircularProgress /></div>}
            </Container>
            </Page>
        </>
    )
...
const maptodispatch = dispatch =>{
    return{
        OnFetchSalary : (token) => dispatch(fetch_employee_salardetails_start(token))
    }
}

export default connect(maptostate,maptodispatch)(SalaryIndex)